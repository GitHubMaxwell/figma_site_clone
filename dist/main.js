...
// module
exports.push([module.i, ".menu-logo {\n  float: left;\n  position: relative;\n  top: 20px;\n  left: 25px; }\n  .menu-logo img {\n    width: 40px; }\n\n.menu-container {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  position: relative;\n  height: 5.5rem; }\n  .menu-container .menu-right-container {\n    display: flex;\n    align-items: center; }\n    .menu-container .menu-right-container ul {\n      list-style: none;\n      display: flex; }\n      .menu-container .menu-right-container ul li {\n        padding: 10px;\n        padding-right: 45px; }\n    .menu-container .menu-right-container .signup {\n      cursor: pointer;\n      background: #3ec28f;\n      width: 80px;\n      height: 33px;\n      border-radius: 5px;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      margin-right: 20px;\n      transition: 200ms; }\n      .menu-container .menu-right-container .signup:hover {\n        background: #24a16e; }\n\n.hero-container {\n  padding: 48px 130px 48px 48px;\n  display: flex;\n  align-items: center;\n  height: 80vh; }\n  .hero-container button {\n    background: #3ec28f;\n    border: none;\n    height: 45px;\n    width: 180px;\n    color: #fff;\n    border-radius: 5px;\n    margin: 0 0 42px 0;\n    font-size: 1em; }\n    .hero-container button:hover {\n      background: #24a16e; }\n  .hero-container .hero-subtitle {\n    margin: 56px 0; }\n  .hero-container iframe {\n    position: absolute;\n    left: 600px;\n    bottom: 65px;\n    border: 2px solid gray;\n    border-bottom: none;\n    border-radius: 20px;\n    padding: 40px;\n    padding-bottom: none; }\n\n.purple-container {\n  display: grid;\n  grid-template-rows: 100px auto;\n  justify-items: center;\n  height: 100vh;\n  width: 100%;\n  background: #8332fb; }\n  .purple-container .arrow_down {\n    filter: invert(100%) opacity(0.5);\n    opacity: 0;\n    padding: 10px;\n    transition: 200ms; }\n    .purple-container .arrow_down.down_arrow_visible {\n      opacity: 1; }\n    .purple-container .arrow_down:hover {\n      cursor: pointer;\n      filter: invert(100%) opacity(1); }\n  .purple-container .sign_up {\n    cursor: pointer;\n    position: fixed;\n    top: -40px;\n    right: 30px;\n    background: #3ec28f;\n    width: 80px;\n    height: 34px;\n    border-radius: 5px;\n    transition: 200ms;\n    display: grid;\n    align-items: center;\n    justify-items: center; }\n    .purple-container .sign_up.signin_slidedown {\n      top: 30px; }\n    .purple-container .sign_up:hover {\n      background: #24a16e; }\n  .purple-container .two-up-container {\n    justify-self: start;\n    align-self: end;\n    display: grid;\n    grid-template-columns: repeat(2, 1fr);\n    width: 100%; }\n    .purple-container .two-up-container img {\n      align-self: end;\n      max-height: 680px; }\n  .purple-container .text-container {\n    padding-left: 80px;\n    max-width: 400px;\n    display: grid; }\n    .purple-container .text-container .text-container-intro h2 {\n      color: #f1c857; }\n      .purple-container .text-container .text-container-intro h2.dark-background {\n        color: #f9846d; }\n    .purple-container .text-container .text-container-intro p {\n      margin: 30px 0; }\n    .purple-container .text-container ul {\n      list-style: none; }\n      .purple-container .text-container ul li {\n        margin: 30px 0; }\n    .purple-container .text-container .author-section {\n      margin-top: 100px; }\n    .purple-container .text-container .author {\n      display: grid;\n      grid-template-columns: auto 1fr;\n      margin-top: 40px;\n      align-items: center; }\n      .purple-container .text-container .author img {\n        width: 35px;\n        margin-right: 12px; }\n\n.footer {\n  display: grid;\n  grid-template-columns: repeat(6, minmax(150px, 1fr));\n  background: white;\n  color: black;\n  padding: 30px 30px 160px 30px; }\n  .footer .footer__list {\n    list-style: none; }\n  .footer li {\n    cursor: pointer;\n    transition: 150ms;\n    line-height: 2em; }\n    .footer li:hover {\n      color: #3bc3fc; }\n  .footer .footer__list__header {\n    cursor: default;\n    font-weight: bold; }\n    .footer .footer__list__header:hover {\n      color: black; }\n  .footer .footer__list__header__logo {\n    font-size: 30px; }\n\n.black-container {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: 700px;\n  align-items: center;\n  justify-items: center; }\n  .black-container .text ul {\n    list-style: none; }\n  .black-container img {\n    justify-self: end;\n    align-self: end;\n    width: 80%;\n    max-height: 500px; }\n\n.gray-container {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  grid-template-rows: 700px;\n  align-items: center;\n  justify-items: center;\n  background: #2c2c2c; }\n  .gray-container .text ul {\n    list-style: none; }\n  .gray-container img {\n    width: 300px; }\n\n.purple-two-container {\n  display: grid;\n  grid-template-rows: 700px;\n  justify-items: center;\n  align-items: center;\n  height: 100vh;\n  width: 100%;\n  background: #7538d7; }\n  .purple-two-container .two-up-container {\n    display: grid;\n    grid-template-columns: repeat(2, 1fr); }\n    .purple-two-container .two-up-container img {\n      max-height: 400px; }\n  .purple-two-container .text-container {\n    padding-left: 80px;\n    display: grid;\n    grid-auto-rows: auto; }\n    .purple-two-container .text-container ul {\n      list-style: none; }\n\n.partner-wrapper {\n  display: grid;\n  grid-template-rows: 500px;\n  justify-items: center;\n  align-items: center;\n  background: white; }\n  .partner-wrapper .partner-container {\n    display: grid;\n    grid-template-columns: 600px;\n    justify-items: center;\n    color: black; }\n    .partner-wrapper .partner-container p {\n      text-align: center;\n      padding: 50px 0; }\n    .partner-wrapper .partner-container img {\n      max-width: 100%; }\n\n.client-wrapper {\n  display: grid;\n  grid-template-rows: 300px;\n  justify-items: center;\n  align-items: start;\n  background: white; }\n  .client-wrapper .client-container {\n    display: grid;\n    grid-template-columns: 600px;\n    justify-items: center;\n    color: black; }\n    .client-wrapper .client-container h2 {\n      padding-bottom: 50px; }\n    .client-wrapper .client-container img {\n      max-height: 42px; }\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0; }\n\nbody {\n  background: #000;\n  color: #fff;\n  font-size: 0.9em;\n  font-family: \"Avenir\", sans-serif;\n  letter-spacing: 0.1ch;\n  font-weight: 100;\n  margin: 0;\n  overflow-x: hidden; }\n\nh1,\nh2,\nh3 {\n  margin: 0;\n  font-weight: 400; }\n\na {\n  color: #fff;\n  text-decoration: none; }\n\n@media screen and (min-width: 1171px) {\n  .projects {\n    grid-template-columns: repeat(4, 1fr); } }\n\n@media screen and (min-width: 769px) and (max-width: 1170px) {\n  .projects {\n    grid-template-columns: repeat(3, 1fr); } }\n\n@media screen and (max-width: 768px) {\n  main {\n    text-align: center;\n    align-items: center; }\n    main .lg-heading {\n      line-height: 1;\n      margin-bottom: 1rem; }\n  ul.menu-nav {\n    transform: translate3d(100%, 0, 0); }\n    ul.menu-nav.show {\n      transform: translate3d(0, 0, 0); }\n  .about-info {\n    grid-template-areas: \"bioimage\" \"bio\" \"job1\" \"job2\" \"job3\";\n    grid-template-columns: 1fr; }\n  .projects {\n    grid-template-columns: repeat(2, 1fr); } }\n\n@media screen and (max-width: 500px) {\n  main#home h1 {\n    margin-top: 10vh; }\n  .projects {\n    grid-template-columns: 1fr; } }\n", ""]);
